...
Vue.component('form-login', __webpack_require__(78));
...
Component.options.__file = "resources\\assets\\js\\auth\\login\\components\\authLogin.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-696ea373", Component.options)
  } else {
    hotAPI.reload("data-v-696ea373", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        submitLogin: function submitLogin() {
            ...
            axios.post("/api/login", this.Auth).then(function (data) {
                _this.successLogin = "";
                window.location = "/";
            }).catch(function (err) {
                if (err.response.data.code == 401) {
                    _this.successLogin = "Tài khoản hoặc mật khẩu không đúng. Xin thử lại";
                    _this.error_s.color = "red";
                } else {
                    _this.successLogin = "Đã có lỗi từ server. Vui lòng thử lại";
                }
            });
        }
    },
      ...
      _c("div", { staticClass: "panel panel-body login-form" }, [
        _c("div", { staticClass: "text-center" }, [
          ...
          _c("h5", { staticClass: "content-group" }, [
            _vm._v("Login bằng tài khoản của bạn "),
            _c("small", { staticClass: "display-block", style: _vm.error_s }, [
              _vm._v(_vm._s(_vm.successLogin))
            ])
          ])
        ]),
        _vm._v(" "),
                  ...
                  on: {
                    change: function($event) {
                      ...
                      if (Array.isArray($$a)) {
                        ...
                        if ($$el.checked) {
                          $$i < 0 &&
                            _vm.$set(_vm.Auth, "remember", $$a.concat([$$v]))
                        } else {
                          $$i > -1 &&
                            _vm.$set(
                              _vm.Auth,
        ...
        _c(
          "a",
          {
            ...
            attrs: { href: "login_registration.html" }
          },
          [_vm._v("Đăng ký")]
        ),
        _vm._v(" "),
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "content-divider text-muted form-group" }, [
      _c("span", [_vm._v("Không có tài khoản?")])
    ])
  },
  function() {
    var _vm = this
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-696ea373", module.exports)
  }
}
