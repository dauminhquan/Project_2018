            ...
            <div class="panel-body">
                <form method="post">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" value="{{$user_data->name_lecturer}}" required  name="name_lecturer" class="form-control">
                            </div>
                            <div class="col-md-6">
                                <label>Địa chỉ của bạn</label>
                                <input type="text" value="{{$user_data->email_address_lecturer}}" required name="address_lecturer" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label>Email</label>
                                <input type="text" value="{{$user_data->email_address_lecturer}}" required name="email_address_lecturer" class="form-control">
                            </div>
                            <div class="col-md-6">
                                <label>Số điện thoại</label>
                                <input type="text" value="{{$user_data->phone_number}}" name="phone_number" class="form-control">
                    ...
                    <div class="">
                        <div class="row">
                            <div class="col-md-6">
                                <label>Khoa giảng dạy: <b>{{$user_data->department_name}}</b></label>

                            </div>
                            <div class="col-md-6">
                                <label>Lĩnh vực hướng dẫn: <b>{{$user_data->field_name}}</b></label>
